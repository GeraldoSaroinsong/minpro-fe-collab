        ...
        try {
            if (eventDetails && eventDetails.id_organizer) {
                const res = await callAPI.get(
                    `user/id/${eventDetails.id_organizer}`
                );
    ...
    const getCategory = async () => {
        try {
            if (eventDetails && eventDetails.id_category) {
                const res = await callAPI.get(
                    `/category/${eventDetails.id_category}`
                );
                ...
                <div className="flex flex-col gap-6 md:flex-row justify-between ">
                    <div className="flex flex-col gap-6 md:w-2/3">
                        <div>
                            ...
                            <p>
                                ...
                                {` s/d `}
                                {new Date(eventDetails?.endDate).toDateString()}
                            </p>
                    ...
                    <div className="md:p-4 flex flex-col gap-4 md:gap-6">
                        ...
                        <div className="text-xl font-semibold">
                            ...
                            IDR {eventDetails?.price * quantity}
                        </div>
